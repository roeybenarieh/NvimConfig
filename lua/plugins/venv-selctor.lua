...
local python_dap_configurations = function(venv_path, venv_python)
  -- some usefull websites to configure dap-python to work with the right venv (besite the):
  -- https://github.com/linux-cultist/venv-selector.nvim
  -- https://github.com/mfussenegger/nvim-dap-python
  -- https://github.com/mfussenegger/nvim-dap-python/blob/master/lua/dap-python.lua
  -- https://github.com/mfussenegger/nvim-dap/wiki/Debug-Adapter-installation#python

  -- other's people configurations:
  ...
  M.setup(debugpy_path .. "/venv/bin/python", setup_opts)
end
...
return {
  {
    ...
    dependencies = {
      ...
      "nvim-telescope/telescope.nvim", -- for the UI used to find venvs
    ...
    opts = function(_, opts)
      ...
      -- add some more folders names representing venv
